...
![alt text](SolutionView1.PNG "Logo Title Text 1")

https://github.com/guihen01/RestApi-JIRA-Lib/blob/main/SolutionView2.PNG

![alt text](SolutionView2.PNG "Logo Title Text 1")
...
![alt text]( Installed nuget packages-1.png "Logo Title Text 1")

1. Packages referenced in the Library : 

![alt text](Dependency-1.PNG "Logo Title Text 1")

# Inplementation

1. Download the nuget package : https://www.nuget.org/packages/RestAPI-JIRA-Lib/ in your project

![alt text](JiraLib-Nuget-package.PNG "Logo Title Text 1")
...
![alt text](Capture-How-to-use.png "Logo Title Text 1")
